...
public class KullaniciGiris extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnKayitEkraninaGec = new javax.swing.JButton();
        ...
        btnKayitEkraninaGec.setText("Kaydolun.");
        btnKayitEkraninaGec.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnKayitEkraninaGecActionPerformed(evt);
            }
        });
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(4, 4, 4)
                        .addComponent(btnKayitEkraninaGec))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(46, 46, 46)
    ...
    private void btnGirisYapActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGirisYapActionPerformed
        ...
        Query q = em.createQuery("SELECT p FROM Kisi_1 p WHERE p.kullaniciAdi=:KADI AND p.sifre=:KSIFRE");
        q.setParameter("KADI", kullaniciAdi);
        q.setParameter("KSIFRE", sifre);
        List<Kisi_1> kisiler = q.getResultList();
        if (kisiler.size() == 1) {
            try {
                try (FileWriter f = new FileWriter(new File("c:\\dosyalar\\SonGirisYapan.txt"))) {
                    f.write("Son giriş yapan kişi: " + kisiler.get(0).getAdi() + " " + kisiler.get(0).getSoyadi());
                }
            } catch (IOException ex) {
                Logger.getLogger(KullaniciGiris.class.getName()).log(Level.SEVERE, null, ex);
            }
            Bulusma_Uygulama b1 = new Bulusma_Uygulama(kisiler.get(0));
            b1.setVisible(true);
            b1.setLocationRelativeTo(null);
            this.dispose();
        } else {
            lblUyari.setText("Yanlışlık var bu işte.");
        }
    }//GEN-LAST:event_btnGirisYapActionPerformed

    private void btnKayitEkraninaGecActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnKayitEkraninaGecActionPerformed
        // TODO add your handling code here:
        KullaniciKayit kk = new KullaniciKayit();
        kk.setVisible(true);
        this.dispose();
    }//GEN-LAST:event_btnKayitEkraninaGecActionPerformed

    private void btnDoktorGirisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDoktorGirisActionPerformed
        // TODO add your handling code here:
        DoktorGirisi Dgiris = new DoktorGirisi();
    ...
    private javax.swing.JButton btnKayitEkraninaGec;
